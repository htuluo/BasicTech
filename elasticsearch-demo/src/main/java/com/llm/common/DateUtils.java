...
//        System.out.println(DateUtils.formatDate(new Date(), DateUtils.YYMMDDHHMMSSSSS));
        System.out.println(DateUtils.formatDate(getTodayBeginTime()));
    }
    ...
    public static long getTodayBeginTimesSecond() {
        long time = getTodayBeginTime().getTime() / 1000;
        return time;
    }
    ...
    public static long getTodayEndTimesSecond() {
        long time = addDays(getTodayBeginTime(), 1).getTime();
        return (time / 1000) - 1;
    }
    ...
    public static Date getTodayBeginTime() {
        Date time = DateUtils.parseDate(DateUtils.formatDate(new Date(), YYYY_MM_DD), YYYY_MM_DD);
        return time;
    }
    ...
    public static long getTodayBeginTimesMillSecond() {
        long time = getTodayBeginTime().getTime();
        return time;
    }
